...
function LimitlessLEDRGB(ipAddress, port, lightGroup) {
...
LimitlessLEDRGB.prototype.sendRGBColorCommand = function( hueVal, callback ) {
	...
	sendUDPCommand(cmdColourByte, hueVal, this.ipAddress, this.port, callback);
};
...
LimitlessLEDRGB.prototype.sendBrightnessUpCommand = function(callback) {
  ...
  sendUDPCommand(cmdByte, valByteNA, this.ipAddress, this.port, callback);
};
